...
import { VhubwebTestModule } from '../../../test.module';
...
describe('Component Tests', () => {
    ...
    describe('Todo Management Detail Component', () => {
        ...
        describe('OnInit', () => {
            ...
            spyOn(service, 'find').and.returnValue(Observable.of(new Todo('aaa')));
            ...
            expect(comp.todo).toEqual(jasmine.objectContaining({id: 'aaa'}));
            });
        });
    });
